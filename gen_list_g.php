...
$sql="SELECT * from `$dept_name` as p,`student_tran` as s ,main as t,auth as f where p.board='wbchse' and p.`category`='OBC-B'and s.subject_id=p.subject_id and s.student_id=t.student_id and s.student_id=f.student_id order by aggr DESC";
